...
export default function Twitter() {
  useEffect(() => {
    ...
    window.location.href = 'https://twitter.com/lexioai';
  }, []);

  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-gray-900 to-black text-white">
      <Head>
        <title>Redirecting to Twitter - lexio.ai</title>
        <meta name="description" content="Redirecting to the lexio.ai Twitter page" />
      ...
      <div className="text-center">
        ...
        <p className="text-white/70 mb-6">You'll be redirected to our Twitter page in a moment.</p>
        <a 
          href="https://twitter.com/lexioai" 
