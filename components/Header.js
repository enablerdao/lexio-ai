        ...
        <div className="flex justify-between items-center py-4">
          <div className="flex items-center">
            <button
              ...
              className="mr-3 p-1 rounded-md text-white/80 hover:text-white hover:bg-white/10 transition-colors"
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-full text-white/80 hover:text-white hover:bg-white/10 transition-colors hidden md:block"
      ...
      {isMenuOpen && (
        ...
        >
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <button
              onClick={toggleTheme}
              className="flex w-full items-center px-3 py-2 rounded-md text-base font-medium text-white/80 hover:text-white hover:bg-white/10 transition-colors duration-200"
            >
              {isDarkMode ? (
                <>
